      ...
      <div className={"grid grid-cols-1 md:grid-cols-2 gap-4"}>
        <div>
          ...
          <textarea
            ...
            rows={2}
            className={
              "mt-2 block w-full px-2 py-1 rounded-md shadow-sm resize-none text-primary-main placeholder:text-primary-light border border-primary-main outline-primary-main text-md"
            }
          />
          <span className={"mt-1 text-xs leading-6 text-primary-main"}>
            You can give a very detailed prompt
          </span>
        </div>
        <div>
          <div className={"w-full"}>
            <label
              htmlFor={"size"}
              className={
                "block text-sm font-medium leading-6 text-primary-main"
              }
            >
              Select Image Size
            </label>
            <select
              ...
              className={
                "mt-2 w-full px-2 py-3 rounded-md shadow-sm border border-primary-main outline-primary-main text-md text-primary-main"
              }
            >
